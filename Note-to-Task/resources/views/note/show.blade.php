...
@section('mainContent')
    <div class="grid grid-rows-2 lg:grid-cols-2 gap-4">
        ...
        <div class="grid grid-cols-1 gap-2 items-start justify-start content-start bg-gray-100 p-4">
                ...
                <div  x-ref="taskContainer" class="grid grid1cols-1" >
                    <!--  below should be in foreach but outside as test  -->
                    ...
                    @if(count($tasks) < 1)
                        <p x-ref = "noTaskMsg">no tasks generated yet, to generate a task use the keyword task e.g.: "task: do stuff" creates task a task with title do stuff </p>
                    @endif 
                </div>
