<nav class="bg-gray-800 p-4">
    <div class="container mx-auto flex items-center justify-between">
        @auth
            ...
            <div x-data = "$store.savingElement">
                <div x-data x-show="!$store.savingElement.isShown" class="rounded p-2 text-white text-lg bg-green-500 font-semibold flex items-center space-x-2">
                    <p class="text-white text-lg font-semibold">saved</p>
